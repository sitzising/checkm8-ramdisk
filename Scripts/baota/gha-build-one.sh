...
alt_ios_list() {
  # A11 末版停在 15.6.1（无 15.7+）；多数机型有 14.8 无 14.8.1
  case "$1" in
    15.0|15.0.*) echo "15.6.1 15.7.1 15.8.3 15.7 15.1 15.0.2" ;;
    14.0|14.0.*) echo "14.8 14.8.1 14.7.1 14.4.2" ;;
    13.7|13.7.*) echo "13.6 13.6.1 13.5.1 13.4.1" ;;
